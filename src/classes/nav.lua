...
function nav:mousepressed(x, y, button)
    local mx, my = x, y
    if self.left then
        if mx > 5 * scale and mx < 5 * scale + self.img:getWidth() and my > wH / 2 - self.img:getHeight() / 2 and my < wH / 2 + self.img:getHeight() / 2 then
            self.current.setScene(self.left)
            collectgarbage("collect")
        end
    end
    if self.right then
        if mx > wW - 5 * scale - self.img:getWidth() and mx < wW - 5 * scale and my > wH / 2 - self.img:getHeight() / 2 and my < wH / 2 + self.img:getHeight() / 2 then
